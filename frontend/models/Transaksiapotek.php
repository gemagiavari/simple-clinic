 ...
 * @property Penerimaanuangapotek $penerimaanuangapotek
 */
class Transaksiapotek extends \yii\db\ActiveRecord
{
    ...
    /**
     * Gets query for [[Penerimaanuangapotek]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getPenerimaanuangapotek()
    {
        return $this->hasOne(Penerimaanuangapotek::class, ['id_faktur' => 'id_faktur']);
    }
}
